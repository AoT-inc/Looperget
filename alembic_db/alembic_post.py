...
from looperget.config import ALEMBIC_UPGRADE_POST
...
def upgrade_revision(error, revision):
    ...
    #     pass  # Code goes here
        ...
        try:
            with session_scope(LOOPERGET_DB_PATH) as session:
        ...
        try:
            ...
            command = f'/bin/bash {INSTALL_DIRECTORY}/looperget/scripts/upgrade_commands.sh setup-virtualenv-full'
        ...
        from looperget.databases.models import DeviceMeasurements
        from looperget.databases.models import Input
        from looperget.databases.models import Math
        from looperget.databases.models import Output
        from looperget.databases.models import OutputChannel
        from looperget.databases.models import PID
        from looperget.databases.models import Trigger
        ...
        from looperget.databases.models import DeviceMeasurements
        from looperget.databases.models import LCD
        from looperget.databases.models import Output
        ...
        from looperget.databases.models import ConditionalConditions
        from looperget.databases.models import Input
        from looperget.inputs.python_code import execute_at_creation
        from looperget.utils.conditional import save_conditional_code
