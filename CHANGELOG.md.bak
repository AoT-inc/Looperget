...
### Features
 ...
 - Add Input: MCP3208 Analog-to-Digital Converter ([#1215](https://github.com/aot-inc/Looperget/pull/1215))
...
### Bugfixes
 ...
 - Fix pressure measurement in BME680 and BME280 Inputs ([#923](https://github.com/aot-inc/looperget/issues/923))
...
### Features
 ...
 - Add Inputs: ADXL34x, ADT7410 ([#791](https://github.com/aot-inc/looperget/issues/791))
...
### Bugfixes
 ...
 - Fix wait time for Atlas Scientific pH Calibration ([#686](https://github.com/aot-inc/looperget/issues/686))
...
### Bugfixes
 ...
 - Fix missing Atlas pH Input baud rate option ([#597](https://github.com/aot-inc/looperget/issues/597))
 - Fix properly displaying I2C/UART Input options
 - Fix issue requiring action selection to submit form ([#595](https://github.com/aot-inc/looperget/issues/595))
...
### Features
 ...
 - Add FTDI support for Atlas Scientific sensors ([#597](https://github.com/aot-inc/looperget/issues/597))
...
### Bugfixes
 ...
 - Fix issue with converted measurements unable to be used with Conditionals ([#592](https://github.com/aot-inc/looperget/issues/592))
 - Add pi-bluetooth to SHT31 Smart Gadget dependencies ([#588](https://github.com/aot-inc/looperget/issues/588))
 - Fix issue using PIDs and Graphs with converted measurement units ([#594](https://github.com/aot-inc/looperget/issues/594))
 - Fix issue with mixed up order of Graph series
 - Fix issue recording output durations

### Features

 - Add OWFS support for 1-wire devices (currently only DS18B20, DS18S20 supported) ([#582](https://github.com/aot-inc/looperget/issues/582))
 - Add ability to delete .dependency and .upgrade files from the web UI ([#590](https://github.com/aot-inc/looperget/issues/590))
...
### Bugfixes
 ...
 - Fix display of proper unit on Measurement Dashboard element ([#583](https://github.com/aot-inc/looperget/issues/583))
 - Fix missing libjpeg-dev dependency for PiOLED ([#584](https://github.com/aot-inc/looperget/issues/584))
 - Fix dependencies for AMG88xx Input

### Features

 - Add Function Action: Create Note
 - Add Input: Sonoff TH10/16 humidity and temperature sensor ([#583](https://github.com/aot-inc/looperget/issues/583))
 - Add Input: AM2320 I2C humidity and temperature sensor ([#585](https://github.com/aot-inc/looperget/issues/585))

### Miscellaneous

 - Change method for detecting 1-wire devices ([#582](https://github.com/aot-inc/looperget/issues/582))
...
### Features
 ...
 - Add Additional check for Conditional Statements if {ID} is replaced with None ([#571](https://github.com/aot-inc/looperget/issues/571))
 - Add ability to set Logging Interval and download logged data from SHT31 Smart Gadget ([#559](https://github.com/aot-inc/looperget/issues/559))
 - Add Math: Input Backup: If a measurement of an Input cannot be found, look for a measurement of another (or another, etc.) ([#559](https://github.com/aot-inc/looperget/issues/559))
...
### Bugfixes
 ...
 - Fix PiOLED LCD from changing I2C address when options are saved ([#579](https://github.com/aot-inc/looperget/issues/579))
 - Fix Generic 16x2/16x4 LCD display issue ([#578](https://github.com/aot-inc/looperget/issues/578))
 - Fix Math Add dropdown items having the same name ([#580](https://github.com/aot-inc/looperget/issues/580))

### Features

 - Add ability to induce an Input to acquire/store measurements from the web UI
 - Add Input: SHT31 Smart Gadget (Bluetooth) humidity/temperature sensor ([#559](https://github.com/aot-inc/looperget/issues/559))
 - Add blank line to LCD display options ([#579](https://github.com/aot-inc/looperget/issues/579))
...
The Looperget 7.0 introduces many redesigned systems, including measurements/units, conversions, conditionals, and more (see full list, below). The remnants of Conditionals have been moved to a new controller, called Triggers, which executes actions in response to event triggers (such as time-based events, Output changes, sunrises/sunsets, etc.). The new Conditional system incorporates a powerful way of developing complex conditional statements. See ([#493](https://github.com/aot-inc/looperget/issues/493)) for more information. Since earlier versions are not compatible with 7.x, all 6.x users will have to perform a fresh install or delete their settings database. An option will be presented on the upgrade page to delete the database and perform an upgrade.

### Bugfixes

 - Fix issue preventing PID Method from changing setpoint (#566)
 - Fix issue with calibration of DS-type sensors
 - Fix module loading issue by restarting the daemon following dependency install ([#569](https://github.com/aot-inc/looperget/issues/569))
 - Fix issue adding Daily Time-Based method ([#550](https://github.com/aot-inc/looperget/issues/550))
...
### Features
 ...
 - Add LCD: PiOLED 128x32 (I2C) LCD ([#579](https://github.com/aot-inc/looperget/issues/579))
 - Add Output: Python Command (On/Off and PWM)
 - Add Output: Atlas EZO-PMP (I2C/UART) Peristaltic Pump ([#562](https://github.com/aot-inc/looperget/issues/562))
 - Add Vapor Pressure Deficit calculation to Inputs that measure temperature and relative humidity ([#572](https://github.com/aot-inc/looperget/issues/572))
 - Add Vapor Pressure Deficit Math controller ([#572](https://github.com/aot-inc/looperget/issues/572))
 - Add Start Offset option for PID, Math, and Conditionals
 - Add ability to search Input selection dropdown list

### Miscellaneous

 - Refactor Conditional system ([#493](https://github.com/aot-inc/looperget/issues/493))
 - Refactor Analog-to-digital converters ([#550](https://github.com/aot-inc/looperget/issues/550))
 - Refactor Measurement/Unit system ([#550](https://github.com/aot-inc/looperget/issues/550))
 - Refactor Conversion system ([#493](https://github.com/aot-inc/looperget/issues/493))
...
This is the final release of version 6.x. Upgrading to 7.x will require a database wipe. This will be an option presented in the Looperget upgrade page. If you do not want to lose your Looperget data (settings AND measurement data), do not upgrade to 7.x.
...
### Bugfixes
 ...
 - Fix issues with ADS1256 module ([#537](https://github.com/aot-inc/looperget/issues/537))
 - Fix issue with saving float values

### Miscellaneous

 - Replace smbus with smbus2 ([#549](https://github.com/aot-inc/looperget/issues/549))
...
### Features
 ...
 - Add ability to set camera still, timelapse, and video file save locations ([#498](https://github.com/aot-inc/looperget/issues/498))
 - Add ability to export/import notes and note attachments ([#548](https://github.com/aot-inc/looperget/issues/548))
...
### Features
 ...
 - Add ability to Test/trigger all Conditional Actions of a Conditional ([#524](https://github.com/aot-inc/looperget/issues/524))

### Bugfixes

 - Fix Cozir module pycozir egg
 - Fix often-erroneous first measurement of ZH03B and MH-Z19 sensors
 - Fix issue with ADS1256 module ([#537](https://github.com/aot-inc/looperget/issues/537))
...
### Features
 ...
 - Add Input: ADS1256 Analog-to-digital converter ([#537](https://github.com/aot-inc/looperget/issues/537))
 - Add ability to create custom options for Input modules ([#525](https://github.com/aot-inc/looperget/issues/525))
...
### Bugfixes
 ...
 - Fix issue with client activating controllers ([#532](https://github.com/aot-inc/looperget/issues/532))
 - Fix issue with Linux Command Input ([#537](https://github.com/aot-inc/looperget/issues/537))
 - Fix issue with installing internal dependencies (e.g. pigpiod) ([#538](https://github.com/aot-inc/looperget/issues/538))
 - Potential fix for Miflora input ([#540](https://github.com/aot-inc/looperget/issues/540))
 - Fix missing Baud Rate option for K30 input ([#541](https://github.com/aot-inc/looperget/issues/541))
 - Fix 500 Error on Raspberry Pi Config page ([#536](https://github.com/aot-inc/looperget/issues/536))
 - Add turning ABC mode off during MHZ19 input initialization ([#546](https://github.com/aot-inc/looperget/issues/546))
 - Fix German "Output" translation

### Miscellaneous

 - Set InfluxDB timeout to 5 seconds ([#539](https://github.com/aot-inc/looperget/issues/539))
 - Update Winsen ZH03B input module code ([#543](https://github.com/aot-inc/looperget/issues/543))
...
### Bugfixes
 ...
 - Fix issue with installing dependencies ([#531](https://github.com/aot-inc/looperget/issues/531))
...
### Bugfixes
 ...
 - Fix issue with 1-Wire devices ([#529](https://github.com/aot-inc/looperget/issues/529))
...
### Bugfixes
 ...
 - Fix issue with note system during upgrade ([#529](https://github.com/aot-inc/looperget/issues/529))
...
This release adds the ability to import input modules, allowing new inputs to be created by the user. Documentation (https://github.com/aot-inc/Looperget/blob/master/looperget-manual.rst#create-your-own-input-module) for developing your own input modules is in development. See issue #525 for more information about it's development and discussion. Also with this release is a new section for Notes (More -> Notes, https://github.com/aot-inc/Looperget/blob/master/looperget-manual.rst#notes). Notes are associated with one more more tags that can be created. Notes can also have files attached to them. These notes can be displayed on graphs to easily identify when a certain event happened in the past (or future).

### Features

 - Implement self-contained input modules ([#525](https://github.com/aot-inc/looperget/issues/525))
 - Add Note system ([#527](https://github.com/aot-inc/looperget/issues/527))
...
### Features
 ...
 - Add Winsen ZH03B Particulate sensor ([#346](https://github.com/aot-inc/looperget/issues/346))
 - Reduce install to one command

### Bugfixes

 - Fix inability to set camera device ([#519](https://github.com/aot-inc/looperget/issues/519))
 - Fix initialization of UART MHZ16 ([#520](https://github.com/aot-inc/looperget/issues/520))
 - Fix issue with BMP280 ([#522](https://github.com/aot-inc/looperget/issues/522))
...
### Bugfixes
 ...
 - Fix issue with PWM output dashboard element updating ([#517](https://github.com/aot-inc/looperget/issues/517))
 - Fix dependency check for DS-type sensor calibration ([#518](https://github.com/aot-inc/looperget/issues/518))
 - Fix issue with Adafruit deprecating BMP, TMP, and CCS811 ([#346](https://github.com/aot-inc/looperget/issues/346), [#503](https://github.com/aot-inc/looperget/issues/503))
...
### Bugfixes
 ...
 - Fix display of IP address on LCD ([#507](https://github.com/aot-inc/looperget/issues/507))
 - Fix graph manual y-axis min/max ([#516](https://github.com/aot-inc/looperget/issues/516))
...
### Features
 ...
 - Add Diagnostic section of configuration menu with first function: Delete All Dashboard Elements ([#515](https://github.com/aot-inc/looperget/issues/515), [#516](https://github.com/aot-inc/looperget/issues/516))

### Bugfixes

 - Fix issue with units on LCDs ([#514](https://github.com/aot-inc/looperget/issues/514))
...
### Features
 ...
 - New measurement/unit configuration system (select which unit to convert/store for input measurements) ([#506](https://github.com/aot-inc/looperget/issues/506))
 - Add ability to create new measurements, units, and conversions ([#506](https://github.com/aot-inc/looperget/issues/506))
 - Enable conversion of disk space (kB, MB, GB), frequency (Hz, kHz, MHz), and humidity (%, decimal)
 - Add option to display IP address on LCD ([#507](https://github.com/aot-inc/looperget/issues/507))
 - Full German Translation ([#507](https://github.com/aot-inc/looperget/issues/507)) (@pmunz75)
...
### Bugfixes
 ...
 - Fix issue activating Cozir CO2 sensor ([#495](https://github.com/aot-inc/looperget/issues/495))
 - Fix issue with order not updating correctly when Conditional is deleted
 - Fix issue with output usage report generation ([#504](https://github.com/aot-inc/looperget/issues/504))
 - Fix proper conversion of temperatures/pressure for Wet-Bulb Humidity Math
 - Fix Atlas pH UART sensor module ([#509](https://github.com/aot-inc/looperget/issues/509))
...
### Features
 ...
 - Add Cozir CO2 sensor Input ([#495](https://github.com/aot-inc/looperget/issues/495))
 - Allow CO2 to be converted from ppm <-> ppb

### Bugfixes

 - Fix pressure measurements being forced to integer ([#476](https://github.com/aot-inc/looperget/issues/476))
 - Fix CCS811 Input measurement ([#467](https://github.com/aot-inc/looperget/issues/467))
 ...
 - Fix issue setting PID setpoint from Dashboard ([#496](https://github.com/aot-inc/looperget/issues/496))
 - Fix displaying custom graph colors ([#491](https://github.com/aot-inc/looperget/issues/491))
...
### Bugfixes
 ...
 - Fix service executable location ([#487](https://github.com/aot-inc/looperget/issues/487))
 - Fix inability to set duty cycle from frontend ([#485](https://github.com/aot-inc/looperget/issues/485))
 - Fix (finally) saving Time-based Conditional times ([#488](https://github.com/aot-inc/looperget/issues/488))
...
### Features
 ...
 - Add option to set Miflora Bluetooth adapter ([#483](https://github.com/aot-inc/looperget/issues/483))

### Bugfixes

 - Fix exception-handling of sending test email ([#471](https://github.com/aot-inc/looperget/issues/471))
 - Fix HDC1000 initialization issue ([#467](https://github.com/aot-inc/looperget/issues/467))
 - Fix Command PWM frontend issues ([#469](https://github.com/aot-inc/looperget/issues/469))
 - Fix ADC modules ([#482](https://github.com/aot-inc/looperget/issues/482))
 - Update miflora to 0.4 ([#481](https://github.com/aot-inc/looperget/issues/481))
 - Fix BH1750 sensor ([#480](https://github.com/aot-inc/looperget/issues/480))
...
- Add CCS811 CO2 sensor input ([#467](https://github.com/aot-inc/looperget/issues/467))
- Add HDC1000/HDC1080 Temperature/Humidity sensor input ([#467](https://github.com/aot-inc/looperget/issues/467))
...
### Bugfixes
 ...
 - Fix saving settings of Conditional Timers ([#470](https://github.com/aot-inc/looperget/issues/470))
 - Fix Command PWM output use in PIDs ([#469](https://github.com/aot-inc/looperget/issues/469))
 - Fix proper display of Outputs in Conditionals ([#469](https://github.com/aot-inc/looperget/issues/469))
...
- Add Output (Duration) Conditional ([#186](https://github.com/aot-inc/looperget/issues/186))

### Bugfixes

 - Fix refreshing settings of active conditional controllers
 - Fix saving settings of Conditional Timers ([#464](https://github.com/aot-inc/looperget/issues/464))
...
### Bugfixes
 ...
 - Fix command measurement checking ([#460](https://github.com/aot-inc/looperget/issues/460))
 - Fix rendering of Math measurements/units ([#461](https://github.com/aot-inc/looperget/issues/461))
...
### Bugfixes
 ...
 - Fix identification of custom command measurement/units ([#457](https://github.com/aot-inc/looperget/issues/457))
 - Fix AM2315 Input issue ([#459](https://github.com/aot-inc/looperget/issues/459))
...
- Add ability to change sample rate of controllers ([#386](https://github.com/aot-inc/looperget/issues/386))

### Bugfixes

 - Fix display of graph custom y-axis names
 - Fix inability to change pigpiod sample rate ([#458](https://github.com/aot-inc/looperget/issues/458))
...
- Add Conditional: Time Span ([#444](https://github.com/aot-inc/looperget/issues/444))

### Bugfixes

 - Fix dependency check ([#422](https://github.com/aot-inc/looperget/issues/422))
 - Try lower integration times when TSL2561 sensor is saturated ([#450](https://github.com/aot-inc/looperget/issues/450))
 - Fix DHT11/DHT22 output power check ([#454](https://github.com/aot-inc/looperget/issues/454))
...
### Bugfixes
 ...
 - Fix scanning for DS18B20 sensors ([#452](https://github.com/aot-inc/looperget/issues/452))
...
### Bugfixes
 ...
 - Fix setting landing page ([#452](https://github.com/aot-inc/looperget/issues/452))
...
### Features
 ...
 - Add Conditionals: Run PWM Method, Daily Time Point Timer, Duration Timer, Output PWM ([#444](https://github.com/aot-inc/looperget/issues/444), [#448](https://github.com/aot-inc/looperget/issues/448))
 - Add Conditional Actions: Activate/Deactivate any controller, Set PID Method ([#440](https://github.com/aot-inc/looperget/issues/440))
 - Use actual range value for color stops of solid gauges ([#434](https://github.com/aot-inc/looperget/issues/434))
 - Add option to set setpoint from PID dashboard element without epanding element ([#449](https://github.com/aot-inc/looperget/issues/449))
 - Refactor Conditional Controllers to be multithreaded

### Bugfixes

 - Fix Hold bug in PID controllers
 - Fix error-handing when changing PID setting from Dashboard if PID is inactive ([#449](https://github.com/aot-inc/looperget/issues/449))

### Miscellaneous

 - Remove multiplexer integration (use kernel driver)
 - Remove Timers (Conditionals have replaced their functionality)
 - Improve testing coverage of frontend ([#444](https://github.com/aot-inc/looperget/issues/444))


## 5.7.3 (2018-04-20)

This is the last version of the 5.x branch. If your system is upgraded to 5.7.3, you will have the option of upgrading to the next major version (6.x), however the settings database will need to be deleted. This can be done through the web UI or manually by reinstalling Looperget fresh.

### Features

 - Add Conditional Action: Set PID Method ([#440](https://github.com/aot-inc/looperget/issues/440))
...
### Features
 ...
 - Add ability to invert PWM duty cycle ([#444](https://github.com/aot-inc/looperget/issues/444))
 - Add ability to select landing page ([#444](https://github.com/aot-inc/looperget/issues/444))
 - Add ability to set setpoint from PID dashboard elements ([#444](https://github.com/aot-inc/looperget/issues/444))
 - Add Conditional Actions: Activate/Deactivate Timer ([#440](https://github.com/aot-inc/looperget/issues/440))

### Bugfixes

 - Fix catching erroneous DS18B20 values ([#404](https://github.com/aot-inc/looperget/issues/404))
 - Fix camera selection of Photo Conditional Action ([#444](https://github.com/aot-inc/looperget/issues/444))

### Miscellaneous

 - Set picamera use_video_port=False ([#444](https://github.com/aot-inc/looperget/issues/444))
 - Rearrange navigation menu ([#444](https://github.com/aot-inc/looperget/issues/444))
...
### Features
 ...
 - Add Input: Xiaomi MiFlora ([#422](https://github.com/aot-inc/looperget/issues/422))

### Bugfixes

 - Restore missing help menu on navigation bar
 - Fix issue reading SHT sensors ([#437](https://github.com/aot-inc/looperget/issues/437))
...
### Features
 ...
 - Add ability to convert Input measurements between units ([#346](https://github.com/aot-inc/looperget/issues/346))
 ...
 - Add Sunrise/Sunset Conditional ([#440](https://github.com/aot-inc/looperget/issues/440))
 - Add ability to set the precision for DS18B20, DS1822, DS28EA00, and DS1825 sensors ([#439](https://github.com/aot-inc/looperget/issues/439))
 - Add Inputs: DS18S20, DS1822, DS28EA00, DS1825, MAX31850K
 - Add Input option to select resolution for DS18B20, DS1822, DS28EA00, and DS1825 ([#439](https://github.com/aot-inc/looperget/issues/439))


### Bugfixes

 - Fix issues with PID control on Dashboard ([#441](https://github.com/aot-inc/looperget/issues/441))
 - Improve LCD controller shutdown speed
 - Fix installer not displaying progress in console ([#442](https://github.com/aot-inc/looperget/issues/442))
 - Force measurement values to float before writing to influxdb (except 'pressure') ([#441](https://github.com/aot-inc/looperget/issues/441))
...
### Bugfixes
 ...
 - Fix issue executing looperget_client.py
 - Fix Command Outputs not turning off after turning on for a duration ([#432](https://github.com/aot-inc/looperget/issues/432))
 - Prevent DS18B20 measurements outside expected range ([#404](https://github.com/aot-inc/looperget/issues/404))
 - Prevent race condition preventing output from remaining on for a duration ([#436](https://github.com/aot-inc/looperget/issues/436))
 - Ensure outputs turned on for a duration only turn off once ([#436](https://github.com/aot-inc/looperget/issues/436))
 - Update sht-sensor to 18.3.6 for Python 3 compatibility ([#437](https://github.com/aot-inc/looperget/issues/437))
...
### Features
 ...
 - Add method to hide/show/reorder all Dashboard Elements at once ([#346](https://github.com/aot-inc/looperget/issues/346))
 - Make Output/PID popups respond to show/hide configuration options ([#346](https://github.com/aot-inc/looperget/issues/346))
 - Add Input: Atlas Electrical Conductivity sensor ([#411](https://github.com/aot-inc/looperget/issues/411))

### Bugfixes

 - Fix issue saving reference resistor value ([#345](https://github.com/aot-inc/looperget/issues/345))
 - Fix LCD display of timestamps
 - Fix inability to change Solid Gauge Stops ([#433](https://github.com/aot-inc/looperget/issues/433))
 - Fix Command Outputs not turning off after turning on for a duration ([#432](https://github.com/aot-inc/looperget/issues/432))
 - Fix encoding issue with df command output ([#430](https://github.com/aot-inc/looperget/issues/430))
...
### Bugfixes
 ...
 - Fix issues with MAX31856/MAX31865 ([#345](https://github.com/aot-inc/looperget/issues/345))
...
### Bugfixes
 ...
 - Add lockfile breaking ([#418](https://github.com/aot-inc/looperget/issues/418))
 - Fix bcrypt dependency issue preventing install ([#429](https://github.com/aot-inc/looperget/issues/429))
...
### Features
 ...
 - Add Input: MAX31865 for PT100 and PT1000 temperature probes ([#345](https://github.com/aot-inc/looperget/issues/345))

### Bugfixes

 - Fix incorrect conversion of I2C address during Atlas pH sensor calibration ([#425](https://github.com/aot-inc/looperget/issues/425))
 - Potential fix for ADC issues when using pre-output ([#418](https://github.com/aot-inc/looperget/issues/418))
 - Fix Linux Command measurement display on lines 2 through 4 of LCDs ([#427](https://github.com/aot-inc/looperget/issues/427))
 - Fix display of PID setpoint units on LCDs
 - Fix display of LCD lines without measurement units
 - Fix locking to be thread safe (replaced fasteners with locket) ([#418](https://github.com/aot-inc/looperget/issues/418))
...
### Bugfixes
 ...
 - Add proper max voltage for MCP3008 ([#418](https://github.com/aot-inc/looperget/issues/418))
 - Fix PID persisting as paused/held after deactivating and activating
 - Fix Atlas pH Calibration issue ([#425](https://github.com/aot-inc/looperget/issues/425))
 - Fix issue with Linux Command Inputs and LCDs ([#427](https://github.com/aot-inc/looperget/issues/427))
...
### Features
 ...
 - Add Input: MAX31856 for measuring several types of thermocouples (K, J, N, R, S, T, E, and B) ([#345](https://github.com/aot-inc/looperget/issues/345)
 - Add looperget_client.py option: get or set PID setpoint, integrator, derivator, kp, ki, and kd ([#420](https://github.com/aot-inc/looperget/issues/420))
 - Add option to enable pre-output during measurement (previously turned off before measurement) ([#418](https://github.com/aot-inc/looperget/issues/418))

### Bugfixes

 - Fix frontend pid in System Information page
 - Fix issue with looperget_client.py PID hold and resume commands
...
### Features
 ...
 - Add ability to use custom command line options for fswebcam camera image captures ([#419](https://github.com/aot-inc/looperget/issues/419))
 - Add Input: MAX31855K for measuring K-type thermocouples ([#345](https://github.com/aot-inc/looperget/issues/345))
 - Add ability to set duty cycle of output via looperget_client.py ([#420](https://github.com/aot-inc/looperget/issues/420))
 - Add Conditional Action: Output PWM ([#420](https://github.com/aot-inc/looperget/issues/420))
 - Add Output Type: Execute Command (PWM) ([#420](https://github.com/aot-inc/looperget/issues/420))
...
### Features
 ...
 - Make install of WiringPi optional ([#412](https://github.com/aot-inc/looperget/issues/412))
 - Make install of numpy optional ([#412](https://github.com/aot-inc/looperget/issues/412))
 - Add pause color and Pause/Hold/Resume buttons to PID Dashboard element options ([#416](https://github.com/aot-inc/looperget/issues/416))
 - Display a log when installing dependencies to follow the progress
 - Add Dependency Install Log to the Log page
 - Add looperget_client.py user commands: pid_pause, pid_hold, pid_resume
 
### Bugfixes

 - Fix issues with PID Conditional Actions ([#416](https://github.com/aot-inc/looperget/issues/416))
 - Fix display of last edge on Live page
 - Fix issue updating the status of some dependencies after their install

### Miscellaneous

 - Remove redundant upgrade commands ([#412](https://github.com/aot-inc/looperget/issues/412))
 - Remove GPIO State from Edge Conditional (use Measurement Conditional) ([#416](https://github.com/aot-inc/looperget/issues/416))
...
### Features
 ...
 - Add Conditional Actions: Pause/Resume PID ([#346](https://github.com/aot-inc/looperget/issues/346))

### Bugfixes

 - Fix pigpiod configuration options when pigpiod is not installed ([#412](https://github.com/aot-inc/looperget/issues/412))
 - Fix setting up pigpiod during install
 - Fix TSL2561 Input module ([#414](https://github.com/aot-inc/looperget/issues/414))
 - Fix Measurement Dashboard element condition/unit display ([#346](https://github.com/aot-inc/looperget/issues/346))
 - Fix saving PID Conditional Actions ([#415](https://github.com/aot-inc/looperget/issues/415))
...
### Features
 ...
 - Make Python modules conditionally imported ([#412](https://github.com/aot-inc/looperget/issues/412))
...
### Features
 ...
 - Add new Input: MCP3008 Analog-to-Digital Converter ([#409](https://github.com/aot-inc/looperget/issues/409))
...
### Features
 ...
 - Add option to set decimal places on Dashboard elements ([#346](https://github.com/aot-inc/looperget/issues/346))
 - Add option to show detailed PID information on Dashboard element ([#346](https://github.com/aot-inc/looperget/issues/346))
 - Add units to PID Dashboard element ([#346](https://github.com/aot-inc/looperget/issues/346))
 - Add Fahrenheit conversion to gauges ([#137](https://github.com/aot-inc/looperget/issues/137))
 - Add new Math: Average (Single Measurement) ([#335](https://github.com/aot-inc/looperget/issues/335))

### Bugfixes

 - Allow disabled pigpiod to persist after upgrades ([#386](https://github.com/aot-inc/looperget/issues/386))
...
### Features
 ...
 - Add PID-Values to Graphs ([#346](https://github.com/aot-inc/looperget/issues/346))
 - Add Dashboard elements: Measurement, Output, PID Control ([#346](https://github.com/aot-inc/looperget/issues/346))
 - Add system date and time to menu

### Bugfixes

 - Add checks to ensure Humidity Math only returns 0% - 100% humidity
 - Prevent opposing relays from being turned off in PID Controllers ([#402](https://github.com/aot-inc/looperget/issues/402))
 - Fix adding and viewing hosts in Remote Admin ([#377](https://github.com/aot-inc/looperget/issues/377))
 - Fix error-handling of DS18B20 communication error ([#404](https://github.com/aot-inc/looperget/issues/404))
 - Add error-handling for influxdb queries ([#405](https://github.com/aot-inc/looperget/issues/405))
...
### Bugfixes
 ...
 - Add error-handling of DS18B20 communication error ([#404](https://github.com/aot-inc/looperget/issues/404))
 - Fix setup abort from unmet pigpiod dependency ([#406](https://github.com/aot-inc/looperget/issues/406))
...
### Features
 ...
 - Add to Pi Settings: select pigpiod sample rate ([#386](https://github.com/aot-inc/looperget/issues/386))
 - Add option to completely disable pigpiod ([#386](https://github.com/aot-inc/looperget/issues/386))
...
### Features
 ...
 - Enable custom minimum/maximum to be set for any y-axis ([#335](https://github.com/aot-inc/looperget/issues/335))
 - Add Asynchronous Graph options for duration of data to display (All or past year, month, week, day)

### Bugfixes

 - Fix saving Math Humidity options ([#400](https://github.com/aot-inc/looperget/issues/400))
...
### Features
 ...
 - Allow multiple data series on Asynchronous Graphs ([#399](https://github.com/aot-inc/looperget/issues/399))
 - Add Outputs and PIDs to Asynchronous Graphs ([#399](https://github.com/aot-inc/looperget/issues/399))
 - Preserve Asynchronous Graph selections after form submissions ([#399](https://github.com/aot-inc/looperget/issues/399))

### Bugfixes

 - Fix reloading of asynchronous graphs ([#399](https://github.com/aot-inc/looperget/issues/399))
...
### Features
 ...
 - Add option to show/hide Gauge timestamp ([#392](https://github.com/aot-inc/looperget/issues/392))
 - Add new Math: Equation ([#335](https://github.com/aot-inc/looperget/issues/335))
 - Add PID control hysteresis ([#398](https://github.com/aot-inc/looperget/issues/398))
 - Automatically restart pigpiod when it fails

### Bugfixes

 - Move pigpiod from cron to systemd service to improve reliability ([#388](https://github.com/aot-inc/looperget/issues/388))
 - Improve deamon error-handling and Input connectivity ([#388](https://github.com/aot-inc/looperget/issues/388))
 - Fix Looperget service timeout ([#379](https://github.com/aot-inc/looperget/issues/379))
...
### Bugfixes
 ...
 - Fix issue with conditionals not triggering when measurement values are 0 ([#387](https://github.com/aot-inc/looperget/issues/387))
 - Fix issue with settings Output PWM duty cycles
 - Fix issues with Atlas UART module ([#382](https://github.com/aot-inc/looperget/issues/382))
 - Fix issues with calibrating the Atlas pH sensor ([#382](https://github.com/aot-inc/looperget/issues/382))
...
### Features
 ...
 - Add new Math: Difference ([#395](https://github.com/aot-inc/looperget/issues/395))

### Bugfixes

 - Fix issue modifying the Conditional Max Age ([#387](https://github.com/aot-inc/looperget/issues/387))
...
### Miscellaneous
 ...
 - Remove debug line from GPIO State Input module ([#387](https://github.com/aot-inc/looperget/issues/387))
...
### Bugfixes
 ...
 - Fix missing pigpio.zip (breaks install/upgrade) on remote server (package pigpio.tar with Looperget)
...
### Features
 ...
 - Add Input: GPIO State ([#387](https://github.com/aot-inc/looperget/issues/387))
 - Refactor Dashboard code (improve load time, reduce code size)

### Bugfixes

 - Fix inability to change Input Period ([#393](https://github.com/aot-inc/looperget/issues/393))
 - Fix Exception while reading the GPIO pin of Edge Conditional ([#387](https://github.com/aot-inc/looperget/issues/387))

### Miscellaneous

 - Add Input Template for the [Wiki](https://github.com/aot-inc/Looperget/wiki/Adding-Support-for-a-New-Input)
...
### Features
 ...
 - Add two new Inputs: Server Ping and Server Port Open ([#389](https://github.com/aot-inc/looperget/issues/389))
...
### Bugfixes
 ...
 - Fix issues with Dashboard Gauges ([#391](https://github.com/aot-inc/looperget/issues/391))
 - Fix issues with Dashboard Cameras

### Miscellaneous

 - Add ID numbers to Conditionals in UI for identification ([#387](https://github.com/aot-inc/looperget/issues/387))
...
### Features
 ...
 - Add ability to set graph y-axis minimum/maximum ([#384](https://github.com/aot-inc/looperget/issues/384))
 - Add ability to view Math outputs on asynchronous graphs ([#335](https://github.com/aot-inc/looperget/issues/335))
 - Improve Dashboard Object creation/manipulation user interaction

### Bugfixes

 - Fix inability to activate Edge Conditionals ([#381](https://github.com/aot-inc/looperget/issues/381))
 - Fix inability to add new gauges or graphs to the dashboard ([#384](https://github.com/aot-inc/looperget/issues/384))
 - Fix issues with UART Atlas pH Input device ([#382](https://github.com/aot-inc/looperget/issues/382))
 - Fix issue with Atlas pH calibration ([#382](https://github.com/aot-inc/looperget/issues/382))
 - Fix issue with caching of Camera images on the Dashboard
 - Fix issue with Edge Conditionals ([#387](https://github.com/aot-inc/looperget/issues/387))
...
### Bugfixes
 ...
 - Fix issue generating output usage reports ([#380](https://github.com/aot-inc/looperget/issues/380))
 - Fix inability to save Edge Conditionals ([#381](https://github.com/aot-inc/looperget/issues/381))
...
### Bugfixes
 ...
 - Fix issue with new installations failing to start the flask frontend ([#379](https://github.com/aot-inc/looperget/issues/379))
 - Fix issue with services starting on Pi Zeros ([#379](https://github.com/aot-inc/looperget/issues/379))
...
- Fix inability to save Gauge Refresh Period option ([#376](https://github.com/aot-inc/looperget/issues/376))
- Fix Atlas Scientific communication issues ([#369](https://github.com/aot-inc/looperget/issues/369))
...
### Bugfixes
 ...
 - Fix issue reading DHT11 sensor ([#370](https://github.com/aot-inc/looperget/issues/370))
...
### Bugfixes
 ...
 - Fix issue with proper python 3 virtualenv ([#362](https://github.com/aot-inc/looperget/issues/362))
 - Fix starting web server during install
 - Fix issue with gunicorn worker timeouts on Raspberry Pi Zeros ([#365](https://github.com/aot-inc/looperget/issues/365))
 - Fix command variable replacement for Output conditionals ([#367](https://github.com/aot-inc/looperget/issues/367))
 - Fix pH Input causing an error with a deactivated Calibration Measurement ([#369](https://github.com/aot-inc/looperget/issues/369))
 - Fix issue preventing capture of still images from the web interface ([#368](https://github.com/aot-inc/looperget/issues/368))

### Miscellaneous

 - Move looperget root symlink from /var/www to /var
 - Create symlinks in PATH for looperget-backup, looperget-client, looperget-commands, looperget-daemon, looperget-pip, looperget-python, looperget-restore, and looperget-wrapper
...
### Features
 ...
 - Add Conditional Actions: Flash LCD Off, LCD Backlight On, LCD Backlight Off ([#363](https://github.com/aot-inc/looperget/issues/363))

### Bugfixes

 - Add more log lines to find out exactly which part makes the end of an upgrade hang
 - Fix MHZ16/19 UART communication ([#359](https://github.com/aot-inc/looperget/issues/359))
 - Fix missing I2C devices from System Information page ([#354](https://github.com/aot-inc/looperget/issues/354))
 - Fix output state determination of other outputs if a wireless output is unconfigured ([#364](https://github.com/aot-inc/looperget/issues/364))
...
### Bugfixes
 ...
 - Fix BME280 sensor module ([#358](https://github.com/aot-inc/looperget/issues/358))
...
With the release of 5.5.0, Looperget becomes modern by migrating from Python 2.7.9 to Python 3 (3.5.3 if on Raspbian Stretch, 3.4.2 if on Raspbian Jessie). This release also brings a big switch from apache2+mod_wsgi to nginx+gunicorn as the web server.
...
Also with this release, exporting and importing both the Looperget settings database and InfluxDB measurement database has been added. These may be imported back into Looperget at a later timer. Currently, the InfluxDB (measurement) database may be imported into any other version of Looperget, and the Looperget (settings) database may only be imported to the same version of Looperget. Automatic upgrading or downgrading of the Looperget database to allow cross-version compatibility will be included in a future release. For the meantime, if you need to restore Looperget settings to a particular Looperget version, you can do the following: download the tar.gz of the particular [Looperget Release](https://github.com/aot-inc/Looperget/releases) compatible with your database backup, extract, install normally, import the Looperget settings database, then perform an upgrade of Looperget to the latest release.
...
A Python 3 compatible binary version of opencv, whoch doesn't require an extremely long (hours) compiling process, is unfortunately unavailable. Therefore, if you know of a library or module that can successfully acquire an image from your webcam (you have tested to work), create a [new issue](https://github.com/aot-inc/Looperget/issues/new) with the details of how you acquired the image and we can determine if the method can be integrated into Mycddo.

### Features

 - Migrate from Python 2 to Python 3 ([#253](https://github.com/aot-inc/looperget/issues/253))
 - Migrate from apache2 (+mod_wsgi) to nginx (+gunicorn) ([#352](https://github.com/aot-inc/looperget/issues/352))
 - Add ability to export and import Looperget (settings) database ([#348](https://github.com/aot-inc/looperget/issues/348))
 - Add ability to export and import Influxdb (measurements) database ([#348](https://github.com/aot-inc/looperget/issues/348))
 ...
 - Add dedicated, modular Conditional controller ([#346](https://github.com/aot-inc/looperget/issues/346))
 - Add PID and Math to input options of Conditionals

### Bugfixes

 - Fix deleting Inputs ([#250](https://github.com/aot-inc/looperget/issues/250))
...
### Bugfixes
 ...
 - Fix issue where Math controller could crash ([#335](https://github.com/aot-inc/looperget/issues/335))
...
### Bugfixes
 ...
 - Fix error on Live page if no Math controllers exist ([#345](https://github.com/aot-inc/looperget/issues/345))
...
### Bugfixes
 ...
 - Fix display of Math controllers with atypical measurements on Live page ([#343](https://github.com/aot-inc/looperget/issues/343))
 - Fix inability to use Math controller values with PID Controllers ([#343](https://github.com/aot-inc/looperget/issues/343))
 - Fix display of Math data on LCDs ([#343](https://github.com/aot-inc/looperget/issues/343))
 ...
 - Fix Date Methods ([#344](https://github.com/aot-inc/looperget/issues/344))
...
### Features
 ...
 - Add Math and PID Controllers to Gauge measurement selection ([#342](https://github.com/aot-inc/looperget/issues/342))
...
### Bugfixes
 ...
 - Fix issue changing Gauge type ([#342](https://github.com/aot-inc/looperget/issues/342))
 - Fix display of multiplexer options for I2C devices
 - Fix display order of I2C busses on System Information page

### Miscellaneous

 - Add new multiplexer overlay option to manual ([#184](https://github.com/aot-inc/looperget/issues/184))
...
### Features
 ...
 - Add Math controller types: Humidity, Maximum, Minimum, and Verification ([#335](https://github.com/aot-inc/looperget/issues/335))
...
### Features
 ...
 - Add first Math controller type: Average ([#328](https://github.com/aot-inc/looperget/issues/328))
...
### Bugfixes
 ...
 - Fix TCA9548A multiplexer channel issues ([#330](https://github.com/aot-inc/looperget/issues/330))
...
### Bugfixes
 ...
 - Fix issue saving Timer options ([#334](https://github.com/aot-inc/looperget/issues/334))
...
### Bugfixes
 ...
 - Fix adding Gauges ([#333](https://github.com/aot-inc/looperget/issues/333))
...
### Features
 ...
 - Add 1 minute, 5 minute, and 15 minute options to Graph Range Selector ([#319](https://github.com/aot-inc/looperget/issues/319))

### Bugfixes

 - Fix AM2315 sensor measurement acquisition ([#328](https://github.com/aot-inc/looperget/issues/328))
...
### Bugfixes
 ...
 - Fix saving user theme ([#326](https://github.com/aot-inc/looperget/issues/326))
...
### Features
 ...
 - Add Freqency, Duty Cycle, Pulse Width, RPM, and Linux Command variables to Conditional commands ([#311](https://github.com/aot-inc/looperget/issues/311)) (See [Input Conditional command variables](https://github.com/aot-inc/Looperget/blob/master/looperget-manual.md#input-conditional-command-variables))
 - Add Graph options: Enable Auto Refresh, Enable Title, and Enable X-Axis Reset ([#319](https://github.com/aot-inc/looperget/issues/319))
 - Add automatic checks for Looperget updates (can be disabled in the configuration)
...
### Features
 ...
 - Add 12-volt DC fan control circuit to manual (@Theoi-Meteoroi) ([#184](https://github.com/aot-inc/looperget/issues/184)) (See [Schematics for DC Fan Control](https://github.com/aot-inc/Looperget/blob/master/looperget-manual.md#schematics-for-dc-fan-control))

### Bugfixes

 - Fix PWM Signal, RPM Signal, DHT22, and DHT11 Inputs ([#324](https://github.com/aot-inc/looperget/issues/324))
...
### Bugfixes
 ...
 - Fix Output Conditional triggering ([#323](https://github.com/aot-inc/looperget/issues/323))
...
### Features
 ...
 - Add Output Conditional If option of "On (any duration)" ([#323](https://github.com/aot-inc/looperget/issues/323)) (See [Output Conditional Statement If Options](https://github.com/aot-inc/Looperget/blob/master/looperget-manual.md#output-conditional-statement-if-options))

### Bugfixes

 - Fix display of first point of Daily Bezier method
 - Fix inability to use Daily Bezier method in PID ([#323](https://github.com/aot-inc/looperget/issues/323))
...
### Features
 ...
 - Force iPhone to open Looperget bookmark as standalone web app instead of in Safari
 - Refactor and add tests for all inputs ([#128](https://github.com/aot-inc/looperget/issues/128))
...
### Bugfixes
 ...
 - Fix inability to modify timer options ([#318](https://github.com/aot-inc/looperget/issues/318))
...
***Note 2: During the upgrade, the web interface will display "500 Internal Server Error." This is normal and you should give Looperget 5 to 10 minutes (or longer) to complete the upgrade process before attempting to access the web interface again.***

### Features

 - Add ability to cycle infinite sets of data on a single LCD display ([#316](https://github.com/aot-inc/looperget/issues/316))
 - Add logrotate script to manage looperget logs
...
### Bugfixes
 ...
 - Fix video streaming with Pi Camera ([#228](https://github.com/aot-inc/looperget/issues/228))
...
### Features
 ...
 - Replace deprecated LockFile with fasteners ([#260](https://github.com/aot-inc/looperget/issues/260))
 - Add Timer type: PWM duty cycle output using Method ([#262](https://github.com/aot-inc/looperget/issues/262)), read more: [PWM Method](https://github.com/aot-inc/Looperget/blob/master/looperget-manual.md#pwm-method)
...
### Features
 ...
 - Add Sample Time option to PWM and RPM Input options ([#302](https://github.com/aot-inc/looperget/issues/302))

### Bugfixes

 - Fix issues with PWM and RPM Inputs ([#306](https://github.com/aot-inc/looperget/issues/306))
...
### Features
 ...
 - Turning Outputs On or Off no longer refreshes the page ([#192](https://github.com/aot-inc/looperget/issues/192))

### Bugfixes

 - Fix exporting measurements
 - Fix Live Data page displaying special characters ([#304](https://github.com/aot-inc/looperget/issues/304))
 - Fix PWM and RPM Input issues ([#302](https://github.com/aot-inc/looperget/issues/302))

## 5.3.1 (2017-10-27)

### Features

 - Add two new Inputs: PWM and RPM ([#302](https://github.com/aot-inc/looperget/issues/302))
 - Allow a PID to use both Relay and PWM Outputs ([#303](https://github.com/aot-inc/looperget/issues/303))
...
Input and Output Conditional commands may now include variables. There are 23 variables currently-supported. See [Conditional Statement variables](https://github.com/aot-inc/Looperget/blob/master/looperget-manual.md#conditional-statement-variables) for details.

 - Add new Input type: Linux Command (measurement is the return value of an executed command) ([#264](https://github.com/aot-inc/looperget/issues/264))
 - Refactor PID input option to allow new input and simplify PID configuration
 - Add ability to select LCD I2C bus ([#300](https://github.com/aot-inc/looperget/issues/300))
 - Add ADC Option to Inverse Scale ([#297](https://github.com/aot-inc/looperget/issues/300))
 - Add ability to use variables in Input/Output Conditional commands

### Bugfixes

 - Fix "Too many files open" error when using the TSL2591 sensor ([#254](https://github.com/aot-inc/looperget/issues/254))
 - Fix bug that had the potential to lose data with certain graph display configurations
 - Prevent more than one active PID from using the same output ([#108](https://github.com/aot-inc/looperget/issues/108))
...
### Miscellaneous
 ...
 - Update Readme and Wiki to fix outdated and erroneous information and improve coverage ([#285](https://github.com/aot-inc/looperget/issues/285))
...
### Bugfixes
 ...
 - Fix Asynchronous Graphs ([#296](https://github.com/aot-inc/looperget/issues/296))
...
### Bugfixes
 ...
 - Fix changing a gauge from angular to solid ([#274](https://github.com/aot-inc/looperget/issues/274))
...
### Features
 ...
 - Add gauges to Live Graphs ([#274](https://github.com/aot-inc/looperget/issues/274))
...
### Bugfixes
 ...
 - Fix issue reporting issue with the web UI communicating with the daemon ([#291](https://github.com/aot-inc/looperget/issues/291))
...
### Bugfixes
 ...
 - Potential fix for certain sensor initialization issues when using a multiplexer ([#290](https://github.com/aot-inc/looperget/issues/290))
 - Handle connection error when the web interface cannot connect to the daemon/relay controller ([#289](https://github.com/aot-inc/looperget/issues/289))
...
### Bugfixes
 ...
 - Fix saving relay start state ([#289](https://github.com/aot-inc/looperget/issues/289))
...
### Bugfixes
 ...
 - Fix MH-Z16 sensor issues in I2C read mode ([#281](https://github.com/aot-inc/looperget/issues/281))
 ...
 - Fix TSL2591 sensor ([#257](https://github.com/aot-inc/looperget/issues/257))
 - Fix saving relay trigger state ([#289](https://github.com/aot-inc/looperget/issues/289))
...
### Features
 ...
 - Add MH-Z16 sensor module ([#281](https://github.com/aot-inc/looperget/issues/281))
...
### Bugfixes
 ...
 - Fix MH-Z19 sensor module ([#281](https://github.com/aot-inc/looperget/issues/281))
...
### Bugfixes
 ...
 - Fix K30 sensor module ([#279](https://github.com/aot-inc/looperget/issues/279))
...
### Bugfixes
 ...
 - Fix install issue in setup.sh install script (catch 1-wire error if not enabled) ([#258](https://github.com/aot-inc/looperget/issues/258))
...
### Bugfixes
 ...
 - Fix new timers not working ([#284](https://github.com/aot-inc/looperget/issues/284))
...
### Bugfixes
 ...
 - Fix setup bug preventing database creation ([#277](https://github.com/aot-inc/looperget/issues/277), [#278](https://github.com/aot-inc/looperget/issues/278), [#283](https://github.com/aot-inc/looperget/issues/283))
...
### Features
 ...
 - Add PWM support as output ([#262](https://github.com/aot-inc/looperget/issues/262))
 ...
 - Add ability to power-cycle the DHT11 sensor if 3 consecutive measurements cannot be retrieved (uses power relay option) ([#273](https://github.com/aot-inc/looperget/issues/273))
...
### Features
 ...
 - Add power relay to AM2315 sensor configuration ([#273](https://github.com/aot-inc/looperget/issues/273))
...
### Features
 ...
 - Add script to check if daemon uncleanly shut down during upgrade and remove stale PID file ([#198](https://github.com/aot-inc/looperget/issues/198))
...
### Bugfixes
 ...
 - Fix install script error ([#253](https://github.com/aot-inc/looperget/issues/253))
 - Fix issue modulating relays if a conditionals using them are not properly configured ([#266](https://github.com/aot-inc/looperget/issues/266))
...
### Features
 ...
 - Add ability to create a Looperget backup
 - Add ability to delete a Looperget backup
 - Remove looperget-wrapper binary in favor of compiling it from source code during install/upgrade

### Bugfixes

 - Fix issue with influxdb database and user creation during install ([#255](https://github.com/aot-inc/looperget/issues/255))
 
### Work in progress

 - Add ability to restore a Looperget backup
...
### Bugfixes
 ...
 - Fix swap size check (and change to 512 MB) to permit pi_switch module compilation size requirement ([#258](https://github.com/aot-inc/looperget/issues/258))
...
### Features
 ...
 - Add TSL2591 luminosity sensor ([#257](https://github.com/aot-inc/looperget/issues/257))
 - Update sensor page to more compact style

### Bugfixes

 - Append setup.sh output to setup.log instead of overwriting ([#255](https://github.com/aot-inc/looperget/issues/255))
...
### Bugfixes
 ...
 - Fix display of PID output and setpoint on live graphs ([#252](https://github.com/aot-inc/looperget/issues/252))
...
### Bugfixes
 ...
 - Fix inability to save SHT sensor options ([#251](https://github.com/aot-inc/looperget/issues/251))
 - Fix inability to turn relay on if another relay is unconfigured ([#251](https://github.com/aot-inc/looperget/issues/251))
...
### Features
  ...
  - Add support for Atlas Scientific pH Sensor ([#238](https://github.com/aot-inc/looperget/issues/238))
  - Add support for calibrating the Atlas Scientific pH sensor
  - Add UART support for Atlas Scientific PT-1000 sensor
  - Update Korean translations
  - Add measurement retries upon CRC fail for AM2315 sensor ([#246](https://github.com/aot-inc/looperget/issues/246))
  ...
  - Add 433MHz wireless transmitter/receiver support for relay actuation ([#88](https://github.com/aot-inc/looperget/issues/88), [#245](https://github.com/aot-inc/looperget/issues/245))

### Bugfixes

  - Fix saving of proper start time during timer creation ([#248](https://github.com/aot-inc/looperget/issues/248))
...
### Features
  ...
  - Add toastr and ajax support for submitting forms without refreshing the page (currently only used with relay On/Off/Duration buttons) ([#70](https://github.com/aot-inc/looperget/issues/70))

### Bugfixes

  - Fix issue with changing ownership of SSL certificates during install ([#240](https://github.com/aot-inc/looperget/issues/240))
...
### Bugfixes
  ...
  - Fix display of unicode characters ([#237](https://github.com/aot-inc/looperget/issues/237))
...
### Features
  ...
  - Add sensor conditional: emailing of photo or video (video only supported by picamera library at the moment) ([#226](https://github.com/aot-inc/looperget/issues/226))

### Bugfixes

  - Fix inability to display Sensor page if unable to detect DS18B20 sensors ([#236](https://github.com/aot-inc/looperget/issues/236))
  - Fix inability to disable relay during camera capture
  - Fix SSL generation script and strengthen from 2048 bit to 4096 bit RSA ([#234](https://github.com/aot-inc/looperget/issues/234))
...
### Bugfixes
  ...
  - Fix BMP280 sensor module initialization ([#233](https://github.com/aot-inc/looperget/issues/233))
...
### Bugfixes
  ...
  - Fix BMP280 sensor I<sup>2</sup>C address options ([#233](https://github.com/aot-inc/looperget/issues/233))
...
### Features
  ...
  - Add BMP280 I2C temperature and pressure sensor ([#233](https://github.com/aot-inc/looperget/issues/233))
...
### Bugfixes
  ...
  - Fix issue with graph page crashing when non-existent sensor referenced ([#232](https://github.com/aot-inc/looperget/issues/232))
...
### Features
  ...
  - New Looperget Manual rendered in markdown, html, pdf, and plain text

### Bugfixes

  - Fix BME280 sensor module to include calibration code (fixes "stuck" measurements)
  - Fix issue with graph page crashing when non-existent sensor referenced ([#231](https://github.com/aot-inc/looperget/issues/231))
...
### Bugfixes
  ...
  - Fix sensor conditional measurement selections ([#230](https://github.com/aot-inc/looperget/issues/230))
  - Fix inability to stream video from a Pi camera ([#228](https://github.com/aot-inc/looperget/issues/228))
  - Fix inability to delete LCD ([#229](https://github.com/aot-inc/looperget/issues/229))
...
### Features
  ...
  - Add BH1750 I2C light sensor ([#224](https://github.com/aot-inc/looperget/issues/224))

### Bugfixes

  - Change default opencv values for new cameras ([#225](https://github.com/aot-inc/looperget/issues/225))
  - Fix relays not recording proper ON duration (which causes other issues) ([#223](https://github.com/aot-inc/looperget/issues/223))
...
### Bugfixes
  ...
  - Fix encoding error when collecting anonymous statistics ([#216](https://github.com/aot-inc/looperget/issues/216))
...
### Bugfixes
  ...
  - Fix pybabel reference during install/upgrade ([#212](https://github.com/aot-inc/looperget/issues/212))
...
### Bugfixes
  ...
  -  Fix edge detection conditional statements ([#214](https://github.com/aot-inc/looperget/issues/214))
  -  Fix identification and conversion of dewpoint on live page ([#215](https://github.com/aot-inc/looperget/issues/215))
...
### Bugfixes
  ...
  - Fix issue with timers not actuating relays ([#213](https://github.com/aot-inc/looperget/issues/213))
...
### Bugfixes
  ...
  - Fix issues with saving LCD options ([#211](https://github.com/aot-inc/looperget/issues/211))
...
### Bugfixes
  ...
  - Fixes inability of relay conditionals to operate ([#209](https://github.com/aot-inc/looperget/issues/209), [#210](https://github.com/aot-inc/looperget/issues/210))
...
### Features
  ...
  - Add ability to check daemon health (looperget_client.py --checkdaemon)
  ...
  - Add new sensor: Looperget Daemon RAM Usage (used for testing)
  - Add ability to use multiple camera configurations (multiple cameras)
  - Add OpenCV camera library to allow use of USB cameras ([#193](https://github.com/aot-inc/looperget/issues/193))
  - Automatically detect DS18B20 sensors in sensor configuration
  - Add ability to create custom user roles
  - Add new user roles: Editor and Monitor ([#46](https://github.com/aot-inc/looperget/issues/46))
...
### Miscellaneous
  ...
  - Move to using a Python virtual environment ([#203](https://github.com/aot-inc/looperget/issues/203))
  ...
  - Restructure database ([#115](https://github.com/aot-inc/looperget/issues/115), [#122](https://github.com/aot-inc/looperget/issues/122))
...
### Bugfixes
  ...
  - Fix asynchronous graph to use local timezone rather than UTC ([#185](https://github.com/aot-inc/looperget/issues/185))

### Miscellaneous

  - Remove archived versions of Looperget (Looperget/old) during upgrade (saves space during backup)
...
### Bugfixes
  ...
  - Fix DHT11 sensor module ([#176](https://github.com/aot-inc/looperget/issues/176))
...
### Bugfixes
  ...
  - Fix DHT11 sensor module, removing exception preventing acquisition of future measurements ([#176](https://github.com/aot-inc/looperget/issues/176))
  - Fix setup.sh install script by adding git as a dependency ([#183](https://github.com/aot-inc/looperget/issues/183))
...
### Bugfixes
  ...
  - Fix camera termination bug ([#178](https://github.com/aot-inc/looperget/issues/178))
  - Fix inability to pause/hold/resume PID controllers

### Miscellaneous

  - Add help text for conditional statements to relay page ([#181](https://github.com/aot-inc/looperget/issues/181))
...
This update also fixes an even more severe bug affecting the database upgrade system. If you installed a system before this upgrade, you are probably affected. This release will display a message indicating if your database has an issue. Deleting ~/Looperget/databases/looperget.db and restarting the web server (or reboot) will regenerate the database.
...
***Important***: Make sure you rename 'user' below to your actual user where you installed Looperget, and make sure the Looperget install directory is correct and points to the correct looperget.service file.

```
sudo service looperget stop
sudo systemctl disable looperget.service
sudo rm -rf /etc/systemd/system/looperget.service
sudo systemctl enable /home/user/Looperget/install/looperget.service
sudo service looperget start
```

### Features

  - Add check for problematic database and notify user how to fix it
  - Add ability to define the colors of lines on general graphs ([#161](https://github.com/aot-inc/looperget/issues/161))

### Bugfixes

  - Update install instructions to correct downloading the latest release tarball
  - Fix for database upgrade bug that has been plaguing Looperget for the past few releases
  ...
  - Fix looperget daemon not automatically starting after install
...
### Bugfixes
  ...
  - Actually fix the upgrade system (looperget_wrapper)
...
### Bugfixes
  ...
  - Fix upgrade system (looperget_wrapper). This may have broke the upgrade system (if so, use the manual method in the README)
  ...
  - Fix gpiod being added to crontab during install from setup.sh ([#174](https://github.com/aot-inc/looperget/issues/174))
...
### Bugfixes
  ...
  - Fix issue with setup.sh when the version of wget<1.16 ([#173](https://github.com/aot-inc/looperget/issues/173))
...
### Bugfixes
  ...
  - Fix DHT11 sensor module not returning values ([#171](https://github.com/aot-inc/looperget/issues/171))
  - Fix HTU21D sensor module not returning values ([#172](https://github.com/aot-inc/looperget/issues/172))


## 4.1.4 (2017-01-13)

This release introduces a new method for upgrading Looperget to the latest version. Upgrades will now be performed from github releases instead of commits, which should prevent unintended upgrades to the public, facilitate bug-tracking, and enable easier management of a changelog.
...
### Features
  ...
  - Add ability to set the language of the web user interface ([#167](https://github.com/aot-inc/looperget/issues/167))
  - Add Spanish language translation
  - New upgrade system to perform upgrades from github releases instead of commits
  - Allow symbols to be used in a user password ([#76](https://github.com/aot-inc/looperget/issues/76))
...
### Bugfixes
  ...
  - Fix inability to start video stream ([#155](https://github.com/aot-inc/looperget/issues/155))
  - Fix SHT1x7x sensor module not returning values ([#159](https://github.com/aot-inc/looperget/issues/159))
...
### Miscellaneous
  ...
  - Move install files to Looperget/install
...
### Features
  ...
  - Add github issue template ([#150](https://github.com/aot-inc/looperget/issues/150) [#151](https://github.com/aot-inc/Looperget/pull/151))
...
### Bugfixes
  ...
  - Fix controller crash when using a 20x4 LCD ([#136](https://github.com/aot-inc/looperget/issues/136))
...
### Features
  ...
  - Create application factory and moved view implementation into a general blueprint ([#129](https://github.com/aot-inc/looperget/issues/129) [#132](https://github.com/aot-inc/Looperget/pull/132) [#142](https://github.com/aot-inc/Looperget/pull/142))
...
### Features
  ...
  - Add BME280 sensor
  - Create basic tests for flask app ([#112](https://github.com/aot-inc/looperget/issues/122))
  - Relocated Flask UI into its own package ([#116](https://github.com/aot-inc/Looperget/pull/116))
...
### Bugfixes
  ...
  - Fix relay conditionals when relays turn on for durations of time ([#123](https://github.com/aot-inc/looperget/issues/123))
  - Exclude photo/video directories from being backed up during upgrade
  - Removed unused imports
  - Changed print statements to logging statements
  - Fix inability to save sensor settings ([#120](https://github.com/aot-inc/looperget/issues/120) [#134](https://github.com/aot-inc/looperget/issues/134))
