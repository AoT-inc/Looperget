...
from looperget.utils.code_verification import create_python_file
from looperget.utils.code_verification import test_python_code
from looperget.utils.constraints_pass import constraints_pass_positive_value
from looperget.widgets.base_widget import AbstractWidget
...
class WidgetModule(AbstractWidget, threading.Thread):
    ...
    def initialize_variables(self):
        ...
        module_name = "looperget.widget.python_code_{}".format(os.path.basename(file_run).split('.')[0])
