...
from looperget.config import ID_FILE
from looperget.config import INSTALL_DIRECTORY
from looperget.config import LOOPERGET_VERSION
from looperget.config import STATS_CSV
from looperget.config import STATS_DATABASE
from looperget.config import STATS_HOST
from looperget.config import STATS_PASSWORD
from looperget.config import STATS_PORT
from looperget.config import STATS_USER
from looperget.databases.models import Actions
from looperget.databases.models import AlembicVersion
...
logger = logging.getLogger("looperget.stats")
...
def add_update_csv(csv_file, key, value):
    ...
    try:
        ...
        uid_gid = pwd.getpwnam('looperget').pw_uid
...
def recreate_stat_file():
    ...
    new_stat_data = [
        ...
        ['Looperget_revision', LOOPERGET_VERSION],
...
def send_anonymous_stats(start_time):
    ...
    try:
        ...
        add_update_csv(STATS_CSV, 'Looperget_revision', LOOPERGET_VERSION)
