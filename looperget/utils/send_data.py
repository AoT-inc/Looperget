...
logger = logging.getLogger("looperget.notification")
...
def send_email(smtp_host, smtp_protocol, smtp_port, smtp_user, smtp_pass,
    ...
    try:
        ...
        outer = MIMEMultipart()
        if not subject:
            subject = "Looperget Notification ({})".format(
                socket.gethostname())
        ...
        # msg['Subject'] = "Looperget Notification ({})".format(
        #     socket.gethostname())
        ...
        #     set_user_grp(out_filename, 'looperget', 'looperget')
