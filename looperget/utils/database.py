...
logger = logging.getLogger("looperget.database")
...
def db_retrieve_table_daemon(
    ...
    while tries > 0:
        ...
        if tries == 1:
            logger.exception(
                "Could not read the Looperget database. "
                "Please submit a New Issue at "
                "https://github.com/aot-inc/Looperget/issues/new")
        else:
            logger.error(
                "The Looperget database is locked. "
