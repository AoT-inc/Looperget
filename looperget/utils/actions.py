...
from looperget.config import PATH_ACTIONS
...
from looperget.utils.influx import get_last_measurement
from looperget.utils.influx import get_past_measurements
from looperget.utils.modules import load_module_from_file
from looperget.utils.system_pi import return_measurement_info

logger = logging.getLogger("looperget.actions")
...
def trigger_action(
    ...
    logger_actions = logging.getLogger("looperget.trigger_action_{id}".format(
...
def trigger_controller_actions(dict_actions, controller_id, message='', debug=False):
    ...
    :return:
    """
    logger_actions = logging.getLogger("looperget.trigger_controller_actions_{id}".format(
