...
from looperget.config import ALEMBIC_VERSION
from looperget.config import INSTALL_DIRECTORY
from looperget.config import USER_ROLES
...
def alembic_upgrade_db():
    ...
    def upgrade_alembic():
        ...
        command = '/bin/bash {path}/looperget/scripts/upgrade_commands.sh update-alembic'.format(path=INSTALL_DIRECTORY)
