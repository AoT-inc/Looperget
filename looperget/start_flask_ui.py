...
from looperget.config import ENABLE_FLASK_PROFILER
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Looperget Flask HTTP server.")
    ...
    if args.ssl:
        ...
        cert = os.path.join(dir_path, "looperget_flask/ssl_certs/server.crt")
        privkey = os.path.join(dir_path, "looperget_flask/ssl_certs/server.key")
