...
# -*- coding: utf-8 -*-
#
#  looperget_client.py - Client to communicate with the Looperget daemon.
#
...
from looperget.config import PYRO_URI
from looperget.databases.models import SMTP, Misc
from looperget.utils.database import db_retrieve_table_daemon
from looperget.utils.send_data import send_email as send_email_notification
...
def parseargs(parser):
    ...
    parser.add_argument('--ramuse', action='store_true',
                        help="Return the amount of ram used by the Looperget daemon")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Client for Looperget daemon.")
