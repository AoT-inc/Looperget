...
if __name__ == "__main__":
    for input_id, input_data in parse_input_information(exclude_custom=True).items():
        ...
        if ('input_manufacturer' in input_data and
                input_data['input_manufacturer'] in ['Linux', 'Looperget', 'Raspberry Pi', 'System']):
            ...
            if name_str in looperget_info and 'dependencies_module' in looperget_info[name_str]:
                ...
                looperget_info[name_str]['dependencies_module'].append(input_data['dependencies_module'])
            else:
                # Only one set of dependencies
                looperget_info[name_str] = input_data
                if 'dependencies_module' in input_data:
                    looperget_info[name_str]['dependencies_module'] = [input_data['dependencies_module']]  # turn into list
        else:
    ...
    list_inputs = [
        (looperget_info, "Built-In Inputs (System)"),
