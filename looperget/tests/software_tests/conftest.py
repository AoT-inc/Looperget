...
from looperget.looperget_flask.app import create_app
from looperget.config import TestConfig
from webtest import TestApp
from looperget.looperget_flask.extensions import db as _db
...
from looperget.databases.models import populate_db
...
def login_user(app, username, password):
    ...
    form['looperget_username'] = username
    form['looperget_password'] = password
