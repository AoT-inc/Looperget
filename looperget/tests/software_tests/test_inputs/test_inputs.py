...
from looperget.inputs.am2315 import InputModule as AM2315Sensor
from looperget.inputs.atlas_ph import InputModule as AtlaspHSensor
from looperget.inputs.atlas_pt1000 import InputModule as AtlasPT1000Sensor
from looperget.inputs.bh1750 import InputModule as BH1750Sensor
from looperget.inputs.bme280 import InputModule as BME280Sensor
from looperget.inputs.bmp180 import InputModule as BMP180Sensor
from looperget.inputs.bmp280 import InputModule as BMP280Sensor
from looperget.inputs.chirp import InputModule as ChirpSensor
from looperget.inputs.dht11 import InputModule as DHT11Sensor
from looperget.inputs.dht22 import InputModule as DHT22Sensor
from looperget.inputs.ds18b20 import InputModule as DS18B20Sensor
from looperget.inputs.htu21d import InputModule as HTU21DSensor
from looperget.inputs.ina219x import InputModule as INA219xSensor
from looperget.inputs.k30 import InputModule as K30Sensor
from looperget.inputs.linux_command import InputModule as LinuxCommand
from looperget.inputs.mh_z16 import InputModule as MHZ16Sensor
from looperget.inputs.mh_z19 import InputModule as MHZ19Sensor
from looperget.inputs.looperget_ram import InputModule as LoopergetRam
from looperget.inputs.rpi_cpu_gpu_temperature import \
    InputModule as RaspberryPiCPUTemp
from looperget.inputs.rpi_signal_pwm import InputModule as SignalPWMInput
from looperget.inputs.rpi_signal_revolutions import InputModule as SignalRPMInput
from looperget.inputs.sht1x_7x import InputModule as SHT1x7xSensor
from looperget.inputs.sht2x import InputModule as SHT2xSensor
from looperget.inputs.system_cpuload import InputModule as RaspberryPiCPULoad
from looperget.inputs.system_freespace import InputModule as RaspberryPiFreeSpace
from looperget.inputs.tmp006 import InputModule as TMP006Sensor
from looperget.inputs.tsl2561 import InputModule as TSL2561Sensor
from looperget.inputs.tsl2591_sensor import InputModule as TSL2591Sensor
from looperget.inputs.ttn_data_storage import InputModule as TTNDataStorage
...
input_classes = [
    ...
    LoopergetRam(None, testing=True),
...
def test__iter__returns_iterator():
    ...
    for index, each_class in enumerate(input_classes):
        ...
        with mock.patch('looperget.inputs.{fn}.InputModule.get_measurement'.format(fn=filename)) as mock_measure:
...
def test_raises_exception():
    ...
    for index, each_class in enumerate(input_classes):
        ...
        with mock.patch('looperget.inputs.{fn}.InputModule.get_measurement'.format(fn=filename), side_effect=IOError):
...
def test_read_returns_1_on_exception():
    ...
    for index, each_class in enumerate(input_classes):
        ...
        with mock.patch('looperget.inputs.{fn}.InputModule.get_measurement'.format(fn=filename), side_effect=Exception):
    ...
    with LogCapture() as log_cap:
        for index, each_class in enumerate(input_classes):
            ...
            print("test_read_logs_unknown_errors: Testing Input ({}/{}): {}".format(
                index + 1, len(input_classes), filename))
            with mock.patch('looperget.inputs.{fn}.InputModule.get_measurement'.format(fn=filename), side_effect=Exception('msg')):
                each_class.read()
            expected_logs = ('looperget.inputs.{fn}'.format(fn=filename),
                             'ERROR',
