...
from looperget.databases.models import CustomController, FunctionChannel
...
from looperget.utils.constraints_pass import (
...
from looperget.utils.lcd import format_measurement_line
...
class CustomModule(AbstractFunction):
    ...
    def initialize(self):
        from looperget.devices.lcd_pioled_circuitpython import PiOLEDCircuitpython
    ...
    def stop_function(self):
        self.device.lcd_write_lines(
            "Looperget {}".format(LOOPERGET_VERSION), "Display Deactivated", "", "")
