...
FUNCTION_INFORMATION = {
    ...
    'dependencies_module': [
        ...
        # used elsewhere in Looperget. All need to be set to the same version in order to prevent conflicts.
    ],
...
class CustomModule(AbstractFunction):
    ...
    def loop(self):
        ...
        try:
            # This log line will appear in the Daemon log under Config -> Looperget Logs
