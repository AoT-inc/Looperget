...
INPUT_INFORMATION = {
    ...
    'dependencies_module': [
        ...
        ('bash-commands',
         [
             '/opt/Looperget/env/RTIMULib_installed',
         ],
         [
             'cd /tmp',
             'git clone https://github.com/RPi-Distro/RTIMULib',
             'cd ./RTIMULib/Linux/python/',
             '/opt/Looperget/env/bin/python setup.py build',
             '/opt/Looperget/env/bin/python setup.py install',
             'touch /opt/Looperget/env/RTIMULib_installed'
         ]),
