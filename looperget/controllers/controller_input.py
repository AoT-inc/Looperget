...
from looperget.databases.models import (SMTP, Conversion,
...
from looperget.utils.inputs import parse_input_information, parse_measurement
from looperget.utils.lockfile import LockFile
...
class InputController(AbstractController, threading.Thread):
    ...
    def update_measure(self):
        ...
        try:
            ...
            self.logger.error(
                "Looperget is attempting to acquire measurement(s) from an Input that has already critically errored. "
