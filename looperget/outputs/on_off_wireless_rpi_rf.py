...
OUTPUT_INFORMATION = {
    ...
    'message': 'This output uses a 315 or 433 MHz transmitter to turn wireless power outlets on or off. '
               'Run /opt/Looperget/looperget/devices/wireless_rpi_rf.py with a receiver to discover the codes '
...
class OutputModule(AbstractOutput):
    ...
    def initialize(self):
        from looperget.devices.wireless_rpi_rf import Transmit433MHz
