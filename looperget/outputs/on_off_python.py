...
self.logger.info(log_string)""",
        ...
        },
        {
            ...
            'phrase': lazy_gettext('Set the state when Looperget starts')
        },
        {
            'id': 'state_shutdown',
            'type': 'select',
            ...
            'phrase': lazy_gettext('Set the state when Looperget shuts down')
        },
        {
...
class OutputModule(AbstractOutput):
    ...
    def initialize(self):
        ...
        try:
            ...
            module_name = "looperget.output.{}".format(os.path.basename(file_run).split('.')[0])
