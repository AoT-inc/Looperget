...
from looperget.config import INSTALL_DIRECTORY, PATH_1WIRE
...
from looperget.looperget_flask.forms import forms_action, forms_input
from looperget.looperget_flask.routes_static import inject_variables
from looperget.looperget_flask.utils import utils_action, utils_general, utils_input
...
logger = logging.getLogger('looperget.looperget_flask.routes_input')
...
def page_input():
    ...
    input_path = os.path.join(
        INSTALL_DIRECTORY,
        'looperget/looperget_flask/templates/pages/data_options/input_options')
    ...
    if not current_app.config['TESTING']:
        for each_input_dev in input_dev:
            if each_input_dev.interface == "FTDI":
                from looperget.devices.atlas_scientific_ftdi import \
