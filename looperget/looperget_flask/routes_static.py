...
from looperget.config import (ALEMBIC_VERSION, INSTALL_DIRECTORY, LANGUAGES,
                           LOOPERGET_VERSION, THEMES, THEMES_DARK)
from looperget.config import PATH_STATIC
from looperget.config_translations import TRANSLATIONS
from looperget.databases.models import Dashboard, Misc
from looperget.looperget_client import DaemonControl
from looperget.looperget_flask.forms import forms_dashboard
from looperget.looperget_flask.routes_authentication import admin_exists
...
def template_exists(path):
    path_start = "{}/looperget/looperget_flask/templates".format(INSTALL_DIRECTORY)
...
# @blueprint.route("/looperget-manual_{}.pdf".format(LOOPERGET_VERSION))
# def download_pdf_manual():
#     """Return PDF Manual."""
#     path_manual = os.path.join(INSTALL_DIRECTORY, "docs")
#     return send_from_directory(path_manual, "looperget-manual.pdf")
...
def page_error(error):
    ...
    dict_return = {
        "trace": trace,
        "version_looperget": LOOPERGET_VERSION,
