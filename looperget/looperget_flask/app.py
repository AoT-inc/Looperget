# coding=utf-8
#
#  app.py - Flask web server for Looperget
#
import base64
import logging
import os
...
from looperget.config import INSTALL_DIRECTORY, LANGUAGES, ProdConfig
from looperget.databases.models import Misc, User, Widget, populate_db
from looperget.databases.utils import session_scope
from looperget.looperget_flask import (routes_admin, routes_authentication,
...
from looperget.looperget_flask.api import api_blueprint, init_api
...
def extension_babel(app):
    def get_locale():
        ...
        # Check for the presence of Looperget/.language with a language
        try:
...
def extension_session(app):
    # TODO: Remove this code if Looperget doesn't produce this issue anymore
    ...
    #     import shutil
    #     shutil.rmtree('/opt/Looperget/looperget/flask_session')
    # except:
    #     pass
