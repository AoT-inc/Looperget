...
from looperget.looperget_flask.forms import forms_output
from looperget.looperget_flask.routes_static import inject_variables
from looperget.looperget_flask.utils import utils_general, utils_output
...
logger = logging.getLogger('looperget.looperget_flask.routes_output')
...
def page_output():
    ...
    output_path = os.path.join(
        INSTALL_DIRECTORY,
        'looperget/looperget_flask/templates/pages/output_options')
