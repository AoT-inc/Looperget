The Looperget client is a command-line tool used to communicate with the daemon.

```console
pi@raspberry:~ $ looperget-client --help
usage: looperget-client [-h] [-c] [--activatecontroller CONTROLLER ID]
...
optional arguments:
  ...
  --deactivatecontroller CONTROLLER ID
                        ...
                        PID, Input
  --ramuse              Return the amount of ram used by the Looperget daemon
